...
class LoginPage(BasePage):
    ...
    def enter_name_and_email_to_sign_up_form_test(self, user_data=UserData):
        self.pasted_text(*login_page_locators.NAME_INPUT_SIGNUP_FORM, user_data.name)
        self.pasted_text(*login_page_locators.EMAIL_INPUT_SIGNUP_FORM, user_data.email)
    ...
    def enter_name_and_email_to_login_form(self, user_data=UserData):
        self.pasted_text(*login_page_locators.EMAIL_INPUT_LOGIN_FORM, user_data.email)
        self.pasted_text(*login_page_locators.PASSWORD_INPUT_LOGIN_FORM, user_data.password)

    def should_be_incorrect_email_login_form_error(self):
        assert self.is_element_present(
            *login_page_locators.VALIDATION_ERROR_YOUR_EMAIL_OR_PASSWORD_INCORRECT_LOGIN_FORM), \
